...
@TestPropertySource(
        "/test.properties") // Config de test chay bang config trong test.properties || Neu khong co thi no se chay bang
// file application.yaml o tren
public class UserControllerTest {
    ...
    void createUser_validRequest_success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("result.id").value("jhfsjdfkjdfn"));
    }
    ...
    void createUser_usernameInvalidRequest_fail() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("message").value("Username must be at least 6 chars"));
    }
}
